...
const kitap = document.getElementsByClassName("kitap");
...
kitaplar.forEach((k) => {
  k.addEventListener("click", (k) => kitabaTiklandi(k));
});

function kitabaTiklandi(k) {
  k.srcElement.innerHTML += `
        <p style="color: #464646; padding:0; margin: 0;">Marka: Metis Yayınları
        Ürün Adı: Yüzüklerin Efendisi Birinci Kısım Yüzük Kardeşliği
        Model: Yüzüklerin Efendisi Birinci Kısım Yüzük Kardeşliği
        Barkod: 9789753425988</p>
